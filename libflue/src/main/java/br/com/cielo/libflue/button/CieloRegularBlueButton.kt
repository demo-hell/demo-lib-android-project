...
class CieloRegularBlueButton @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.CieloRegularBlueButton,
            0,
            0).apply {
            try {
                getString(R.styleable.CieloRegularBlueButton_android_text)?.let {
                    this@CieloRegularBlueButton.text = it
                }
                getBoolean(R.styleable.CieloRegularBlueButton_android_enabled, true).let {
                    isEnabled = it
                }
            } finally {
                recycle()
